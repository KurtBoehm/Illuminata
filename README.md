...
Illuminata (named in reference to a character in _[Pentiment](https://pentiment.obsidian.net/)_) is a PDF viewer geared towards presentations, featuring support for a full-screen mode, hiding the cursor, panning and zooming, and a dark mode with luminance-only inversion.
